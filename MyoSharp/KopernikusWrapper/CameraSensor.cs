    ...
    public class CameraSensor : Sensor
    {
        ...
        void StartConnect()
        {
            ...
            try
            {
                ...
                if (!connectSuccess)
                {
                    ...
                    Console.WriteLine(string.Format("Client unable to connect. Failed"));
                }
            }
            catch (System.Exception ex)
            {
                Console.WriteLine(string.Format("Client exception on beginconnect: {0}", ex.Message));
                connectState = ConnectionState.Unavailable;
            }
        ...
        void ProcessData(int numBytesRecv)
        {
            ...
            */
            ...
            Console.WriteLine("Received: "+numBytesRecv);
